...
public class ExcelUtils {
	...
	public Object[][] getSimpleExcelData(String fileName, String sheetName) throws Exception {
		...
		fileName = new File(String.format("%s/resources", System.getProperty("user.dir"))).getAbsolutePath() + "\\"
				+ fileName;
			...
			if (isEmpty(row)) {
				...
				for (int colNum = 0; colNum < numberOfColumns; colNum++) {
					...
					if (cell != null && cell.getCellType() != Cell.CELL_TYPE_BLANK) {
						data[rowNum - 1][colNum] = objectFrom(workbook, cell);
					}
				}
			}
		}
	...
	public Object[][] getComplexExcelData(String fileName) throws Exception {
		fileName = new File(String.format("%s/resources", System.getProperty("user.dir"))).getAbsolutePath() + "\\"
				+ fileName;
		XSSFWorkbook workbook = getWorkBook(fileName);
